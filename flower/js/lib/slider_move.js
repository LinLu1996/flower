define(['util', 'animate', 'slider'], function(util, animate, Slider) {
	...
	function Slider_move(imgs, parent, a) {
	...
	Slider_move.prototype = new Slider();
	Slider_move.prototype.constructor = Slider_move;
	Slider_move.prototype.init = function() {
		//创建轮播组件容器
	...
	Slider_move.prototype.createImg = function(index) {
	...
	Slider_move.prototype.changeAuto = function() {
		var _this = this;
	...
	Slider_move.prototype.setindicator = function() {
		var that = this;
		for(var i = 0; i < this.imgs.length; i++) {
	...
	Slider_move.prototype.getStatu = function() {
		for(var i = 0; i < this.imgs.length; i++) {
